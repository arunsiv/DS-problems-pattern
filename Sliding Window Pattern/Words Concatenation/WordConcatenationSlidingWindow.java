...
// O(lM + N * Len) time | O(M + Len) space
// N is the length of the string
// M is the length of the words array
// Len is the length of each word
public class WordConcatenationSlidingWindow {
    ...
    public static void main(String[] args) {
        WordConcatenationSlidingWindow wordConcatenationSlidingWindow = new WordConcatenationSlidingWindow();

        List<Integer> result = wordConcatenationSlidingWindow.findSubstring(
                "bcabbcaabbccacacbabccacaababcbb", new String[] { "c", "b", "a", "c", "a", "a", "a", "b", "c" });
        System.out.println(result);

        result = wordConcatenationSlidingWindow.findSubstring("a", new String[] { "a" });
        System.out.println(result);

        result = wordConcatenationSlidingWindow.findSubstring(
                "wordgoodgoodgoodbestword", new String[] { "word", "good", "best", "word" });
        System.out.println(result);

        result = wordConcatenationSlidingWindow.findSubstring("catfoxcat", new String[] { "cat", "fox" });
        System.out.println(result);
    }
}